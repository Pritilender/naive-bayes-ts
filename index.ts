...
'--fix-data' - reformat test and train data`)
  ...
  if (args.has('--train') || args.has('-t')) {
    ...
    bayesClassifiers.forEach(el => el.classifier.parseFile(el.path))
  }
